...
MySQL - 5.6.32-1+deb.sury.org~xenial+0.1 : Database - mobile_firmware
*********************************************************************
*/
...
insert  into `tutorials`(`id`,`st_instruct`,`requirements`,`title`,`description`,`noted`,`created_at`,`updated_at`) values (1,'test','test','test','test','test',NULL,NULL);
